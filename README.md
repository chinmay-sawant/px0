...
- **Rendered Markdown & Mermaid Diagrams**: `.md` files open as a rendered GitHub-Flavored Markdown document (`Alt+M` toggles source/preview), with theme-highlighted code fences and Mermaid diagrams drawn lazily in the browser in cards with zoom and pan.
