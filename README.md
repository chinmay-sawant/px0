...
- **Rendered Markdown & Mermaid Diagrams**: `.md` files open as a rendered GitHub-Flavored Markdown document (`Alt+M` toggles source/preview per tab), with theme-highlighted code fences and Mermaid diagrams drawn lazily in the browser.
